...
describe("largestNumber", function() {
    it("should return 10 when we pass [1,3,10] as an argument", function() {
        expect(largestNumber([1, 3, 10])).toEqual(10);
    });
    it("should return 10 when we pass [5,39,1000,2000] as an argument", function() {
        expect(largestNumber([5, 39, 1000, 2000])).toEqual(2000);
    });
    it("should return 10 when we pass [100,3,39,89,20,10] as an argument", function() {
        expect(largestNumber([100, 3, 39, 89, 20, 10])).toEqual(100);
    });
});